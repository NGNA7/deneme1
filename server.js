...
const embedlulz = new Discord.RichEmbed()
    .setTitle("Sunucunda " + msg.author.tag + " reklam yapıyor!")
      .setColor(0x00AE86)
      .setDescription("k!uyar <kişi> komutu ile onu uyarabilir ya da k!kick <kişi> veya k!ban <kişi> komutlarını kullanarak onu sunucudan uzaklaştırabilirsin!")
...
client.on('message', msg => {
  if (msg.content.toLowerCase() === 'sa selamun aleyküm') {
